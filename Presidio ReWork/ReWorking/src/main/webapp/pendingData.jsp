...
<body>
	<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver"
		...
		password="1234" />
	<sql:query var="rs" dataSource="${db}"> select *from bookingdetails where CurrentStatus = 'pending'; </sql:query>
	<div class="table">
		<div class="table_header">
			<p>
				<b style="font-size: 20px;font-weight:bold;">BOOKED DETAILS </b>
			</p>
